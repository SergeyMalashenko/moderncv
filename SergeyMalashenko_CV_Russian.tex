...
Под моим руководствои и непосредственном участии разработана система детектирования и распознавания регистрационных знаков (многонациональная). Собраны и обработаны необходимые наборы данных, разработан инструмент для генерации искусственных изображений регистрационных знаков. Проанализированы доступные научные публикации и построены требуемые модели для детектирования объектов и распознавания текста.
...
\newline{}
Был руководителем совместного проекта с ОКБМ им. Африкантова. В рамках проекта применил теорию подобия для анализа поставленной задачи, нашим коллективом были выполнены численные эксперименты, которые позволили обосновать применимость некоторых моделей турбулентности для решения поставленной задачи.
}
